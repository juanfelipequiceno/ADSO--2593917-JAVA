...
public class ModificarVendedor extends javax.swing.JFrame {
    ...
    InterVendedor vendedor;
    
    public ModificarVendedor(InterVendedor vendedor) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vendedor encontrado:");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        Vendedor temporal = this.vendedor.ventana.data_base.buscarVendedor(cedula);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        Vendedor temporal = new Vendedor(cedula, nombres, apellidos, telefono, email,"");
        
        if (!cedula.equals("") && !nombres.equals("") && !apellidos.equals("") && !telefono.equals("") && !email.equals("") ) {
            boolean proceso =  this.vendedor.ventana.data_base.editarVendedor(temporal) ;
            dispose();
           this.vendedor.actualizarVendedor();
            this.vendedor.setVisible(true);
