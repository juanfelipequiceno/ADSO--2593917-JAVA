...
public class EliminarUsuario extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(buscarCampoCedulaEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        if(this.buscarCampoCedulaEliminar.getText() == ""){
            ...
            for(int i=0; i<this.ventanaMenu.indexPerosna;i++){
                if(this.ventanaMenu.listapersona[i]!=null){
                    if(this.ventanaMenu.listapersona[i].getCedula().equals(this.cedula1)){
    ...
    private void eliminarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarUsuarioActionPerformed
        ...
        for(int i=this.temp;i<this.ventanaMenu.listapersona.length-1;i++){
            this.ventanaMenu.listapersona[i]=this.ventanaMenu.listapersona[i+1];tjis
        }
        this.ventanaMenu.listapersona[ this.ventanaMenu.listapersona.length-1 ] = null;
        
        for(int j=0;j<this.ventanaMenu.listapersona.length;j++){
            if(this.ventanaMenu.listapersona[j]!=null){
                System.out.println(this.ventanaMenu.listapersona[j].getNombre());
            }
