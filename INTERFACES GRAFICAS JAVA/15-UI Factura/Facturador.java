...
public class Facturador extends JFrame{
	...
	// Metodos
	public Facturador(Persona[] listaClientes, Vendedor[] listaVendedores){
	...
	public void buscarVendedor(){
		...
		if(encontrado1){
			deshabilitarInputVendedor(this.input_nombres_vendedor);
			this.input_cedula_vendedor.requestFocus();
		}else{
	...
	public void deshabilitarInputVendedor(JTextField input){
		input.setEditable(false);
		input.setEnabled(false);
		input.setDisabledTextColor(Color.black);
	}
